...
func main() {
	...
	root.AddCommand(startCmd, versionCmd, newTUICmd(), newSkillCmd(), newMemoryCmd(), newMCPCmd(), newReplayCmd(), newProposalsCmd(), newCostsCmd(), newCorrectCmd(), newUndoCmd(), newHoldsCmd(), newWorldCmd(), newAttentionCmd(), newTrustCmd(), newCanaryCmd(), newSoulCmd())
